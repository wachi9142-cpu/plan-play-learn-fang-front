...
| **การเรียนรู้** — กำหนดการสอน | `/schedules`, `/schedules/[id]` | ✅ (รอสัปดาห์ 6–13) |
...
| 📚 ห้องสมุด (hub) · 📚 ชั้นหนังสือ · 🧸 มุมหนังสือ · 🗂️ คลังสื่อรวม | `/library`, `/library/shelf`, `/library/kids`, `/library/media` | ✅ |
...
- **โน้ตบุ๊ก/เดสก์ท็อป (≥ 1024px)**: หน้าแรก | เกี่ยวกับ▾ | การเรียนรู้▾ | 📚 ห้องสมุด▾ | ปฏิทินโรงเรียน | กิจกรรมโรงเรียน | ประชาสัมพันธ์ | ติดต่อเรา | เข้าสู่ระบบ
