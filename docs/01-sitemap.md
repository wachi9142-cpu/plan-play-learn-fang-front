...
| 🎮 เกม — เล่นสนุก/สร้างสรรค์ | `/play` | ✅ |
| 🧩 เกมการศึกษา (3 ระดับทุกเกม · เชื่อมหลักสูตร) | `/games`, `/games/[id]`, `/games/progress` | ✅ |
...
| ⚙️ ตั้งค่า — ธีม ☀️🌙⚙️ · เอฟเฟกต์ ❄️🌸🍂🌠 · ทางลัด | `/settings` | ✅ |

## Navigation ตามขนาดจอ
- **มือถือ (≤ 767px)**: โลโก้ + ☰ (เมนูเต็มจอ) + แถบลอย (📢 📝 🎮 🏆 🔍)
- **แท็บเล็ต (768–1023px)**: หน้าแรก | เกี่ยวกับ▾ | เมนู▾ | ☰ ที่เหลือ
- **โน้ตบุ๊ก/เดสก์ท็อป (≥ 1024px)**: หน้าแรก | เกี่ยวกับ▾ | การเรียนรู้▾ (รวม 📚 ห้องสมุด) | ติดต่อเรา | 🌱 นาฬิกา | ☀️/🌙 ธีม | เข้าสู่ระบบ
- **แถบลอยด้านขวา (≥ 768px)**: 📅 ปฏิทิน · 🎈 กิจกรรม · 📢 ประชาสัมพันธ์ · 📝 ใบงาน · 🎮 เกม · 🏆 ผลงานเด็ก · 🔍 ค้นหา
  (3 เมนูแรกไม่ซ้ำไว้บนแถบบน เพราะอยู่ในแถบลอยแล้ว · บนมือถือย้ายไปเป็นปุ่มใหญ่ 3 ช่องบนสุดของเมนู ☰)

## จุดเข้าถึงเมนูตั้งค่า ⚙️
| อุปกรณ์ | อยู่ตรงไหน |
|---|---|
| มือถือ (< 640px) | เมนู ☰ → ⚙️ ตั้งค่า (แถบบนไม่พอที่ จึงไม่แสดงปุ่มธีม) |
| แท็บเล็ตขึ้นไป (≥ 640px) | ปุ่มเล็ก ☀️/🌙/⚙️ บนแถบบนสุด ข้างนาฬิกา |
| ทุกอุปกรณ์ | หน้า `/settings` — การ์ดเลือกธีมพร้อมภาพตัวอย่าง + สวิตช์ ❄️ |
