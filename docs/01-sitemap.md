...
| ⚙️ ตั้งค่า — ธีม ☀️🌙⚙️ · โหมดฤดูหนาว ❄️ · ทางลัด | `/settings` | ✅ |

## Navigation ตามขนาดจอ
- **มือถือ (≤ 767px)**: โลโก้ + ☰ (เมนูเต็มจอ) + แถบลอย (📢 📝 🎮 🏆 🔍)
- **แท็บเล็ต (768–1023px)**: หน้าแรก | เกี่ยวกับ▾ | เมนู▾ | ☰ ที่เหลือ
- **โน้ตบุ๊ก/เดสก์ท็อป (≥ 1024px)**: หน้าแรก | เกี่ยวกับ▾ | การเรียนรู้▾ | 📚 ห้องสมุด▾ | ปฏิทินโรงเรียน | กิจกรรมโรงเรียน | ประชาสัมพันธ์ | ติดต่อเรา | 🌱 นาฬิกา | ☀️/🌙 ธีม | เข้าสู่ระบบ
...
| แท็บเล็ต/เดสก์ท็อป (≥ 768px) | ⚙️ ตั้งค่า ในแถบลอยด้านขวา (เปิดเมนูธีมได้เลย) |
