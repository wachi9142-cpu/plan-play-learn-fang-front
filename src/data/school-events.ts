...
export interface SchoolEvent {
  ...
  prepare?: string[];
  /** 💡 สิ่งที่ "แนะนำ" ให้เตรียม — ไม่บังคับ ถ้าไม่มีมาทางโรงเรียนเตรียมไว้ให้ */
  suggest?: string[];
...
export const SCHOOL_EVENTS: SchoolEvent[] = [
  ...
  },
  {
    ...
    suggest: ["ปากกาส่วนตัวสำหรับจดบันทึกระหว่างประชุม (ถ้าไม่ได้เตรียมมา ทางครูมีเตรียมไว้ให้ค่ะ)"],
