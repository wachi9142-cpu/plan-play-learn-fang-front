...
export interface CoreActivity {
  ...
  tint: string;
  icon?: string;    // ภาพแทนอีโมจิ
  cover?: boolean;  // true = ภาพถ่ายเต็มกรอบ (ครอป) · false/ไม่ใส่ = ภาพตัดพื้นหลัง
}

/** 🎈 6 กิจกรรมหลัก — หมวดของกิจกรรมการจัดประสบการณ์ (ไม่ใช่คลังเกมออนไลน์) */
export const CORE_ACTIVITIES: CoreActivity[] = [
  {
    type: "circle", order: 1, emoji: "🎵", icon: "/activities/circle.webp", cover: true, title: "กิจกรรมเคลื่อนไหวและจังหวะ", short: "เคลื่อนไหว", tint: "bg-sky-soft",
  ...
  {
    type: "story", order: 2, emoji: "💬", icon: "/activities/story.webp", cover: true, title: "กิจกรรมเสริมประสบการณ์", short: "เสริมประสบการณ์", tint: "bg-yellow-soft",
  ...
  {
    type: "creative", order: 3, emoji: "🎨", icon: "/activities/creative.webp", cover: true, title: "กิจกรรมสร้างสรรค์ (ศิลปะสร้างสรรค์)", short: "สร้างสรรค์", tint: "bg-pink-soft",
  ...
  {
    type: "free", order: 4, emoji: "🧸", icon: "/activities/free.webp", cover: true, title: "กิจกรรมเสรี (เล่นตามมุม)", short: "เสรี", tint: "bg-mint-soft",
  ...
  {
    type: "outdoor", order: 5, emoji: "🌳", icon: "/activities/outdoor.webp", cover: true, title: "กิจกรรมกลางแจ้ง", short: "กลางแจ้ง", tint: "bg-[#e8f3d6]",
  ...
  {
    type: "game", order: 6, emoji: "🧩", icon: "/activities/game.webp", cover: true, title: "กิจกรรมเกมการศึกษา", short: "เกมการศึกษา", tint: "bg-purple-100",
