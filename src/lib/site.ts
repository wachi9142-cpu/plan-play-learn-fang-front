...
export const SITE = {
  ...
  welcomeIntro: "Little Purple Garden พื้นที่แห่งการเรียนรู้สำหรับเด็กปฐมวัย ที่เปิดโอกาสให้เด็กได้เล่น ทดลอง ลงมือทำ และเรียนรู้ผ่านประสบการณ์ที่เหมาะสมกับวัย พร้อมส่งเสริมพัฒนาการอย่างรอบด้าน",
